...
export const sistemaDescricao = 'Sistema de cotrole de frequência';
export const sistemaVersao = '1.0.0-00';
export const domainNameProd = 'siconf-pro.pc.goias.gov.br/';
export const domainNameHomo = 'siconf.pc.goias.gov.br/';
