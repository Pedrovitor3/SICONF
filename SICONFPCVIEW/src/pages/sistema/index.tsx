...
const Sistema: React.FC = () => {
  ...
  const [frequenciaId, setFrequenciaId] = useState<string>('');
  ...
  const handleFrequenciaIdChange = (id: string) => {
    setFrequenciaId(id);
  };
      ...
      <Layout style={{ height: '100vh', width: '100%' }}>
        ...
        <Layout className="site-layout">
                ...
                {
                  {
                    ...
                    '2': <span>Frequência</span>,
                    '3': <span>Planilha</span>,
                  }[chave]
                }
              </Breadcrumb.Item>
            </Breadcrumb>
                  ...
                  {
                    {
                      ...
                      '2': (
                        <Board
                          ...
                          onFrequenciaIdChange={handleFrequenciaIdChange}
                        />
                      ),
                      '3': (
                        <Planinha
          ...
          <Footer style={{ textAlign: 'center' }}>
            {sistemaNameSSO} ©2023 Inovação e Tecnologia
          </Footer>
        </Layout>
      </Layout>
      <Modal
